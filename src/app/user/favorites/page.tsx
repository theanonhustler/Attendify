  ...
  return (
    <section className="container mx-auto mt-24 mb-48 p-4 md:p-4 lg:p-0">
      ...
      <div className="relative">
        ...
        <input
          type="text"
          className="mb-8 p-2 w-full pr-12  md:w-1/2 md:pr-12 lg:w-1/2 lg:pr-12   font-jakarta rounded-sm border-2 border-[#5D77A280] bg-[#180A38] outline-none text-gray-200"
      ...
      <div className="grid gap-12 md:grid-cols-2 md:gap-8 lg:grid-cols-3 lg:gap-12">
        ...
        {/* <div className='relative bg-card'>
            <div>
                <Image src="/assets/night.svg" className='w-full'/>
                </div>

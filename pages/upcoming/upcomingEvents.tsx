  ...
  return (
    ...
    <section className="container  mx-auto mt-24 mb-48 p-4 md:p-0 lg:p-0">
      ...
      <div className="grid gap-12 md:grid-cols-2 md:gap-8 lg:grid-cols-3 lg:gap-12">
        {/* COLUMN-1 */}
        <Link className="cursor-pointer" href="/event/eventInfo">
        <div className="flex border border-[#3D33A9] p-2 relative rounded-lg md:border-0 md:p-0  md:block md:relative lg:border-0 lg:block lg:relative lg:p-0 bg-card">
          ...
          <div>
            ...
            <div className="absolute bottom-4 right-20  md:absolute md:right-4 md:bottom-36 lg:absolute  lg:right-4 lg:bottom-36">
